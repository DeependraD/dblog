...
authors:
- deependrad
bio: My research interests include design of experiments and mathematical intrepretation of biological systems.
education:
  courses:
...
- icon: twitter
  icon_pack: fab
  link: https://twitter.com/dd_rookie
- icon: google-scholar
  icon_pack: ai
  link: 
- icon: github
  icon_pack: fab
  link: https://github.com/deependrad
superuser: false
title: Deependra
user_groups:
- Researchers
