...
Notes: Loading matrix is the adjustment matrix ($\alpha$ matrix). The elements of α determine the speed of adjustment to the long-run equilibrium.
...
Introduction to econometrics with R, Cointegration
