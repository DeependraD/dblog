...
$$
G_x = \left[\frac{T_x}{n-2}\right]-\left[\frac{\sum T}{n(n-2)}\right]
$$

Where x represents a specific line. Using fabricated dataset given in Table \@ref(tab:fabricated-diallel) following procedures outlines how GCA for line B ($GCA_b$) can be calculated.

$$
G_b = \left[\frac{T_x}{n-2}\right]-\left[\frac{\sum T}{n(n-2)}\right] \\
= \left[\frac{226}{8}\right]-\left[\frac{226}{8}\right] \\
= 28.25-25.3 \\
= 2.95
$$
