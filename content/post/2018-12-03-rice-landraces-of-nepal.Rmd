...
tags:
  - agriculture
header:
  caption: 'Anadi rice growing near maturity; Source: Baluwaphanta, Kailali'
  image: 'rice_landraces/anadi_kailali.jpg'
---
...
```{r riceland}
rice_landraces <- read_csv("./data/rice_landraces_past_reflection.csv", comment = "#")
rice_landraces %>%
